...
var DeployViewModel = function (deploySignalR, curTypeCached, curTimeCached, smokeTypeCached, smokeTimeCached) {
    ...
    self.submitStatus = function () {
        ...
        var notifKey = ko.unwrap(statusFromID(self.statusModalStatus(), self.status())).statusName;
        var notifValue = ko.unwrap(notifKey);
    ...
    ///4) Quick Deploy Modal Functions
